...
import com.toleckk.insta.web.rest.errors.EmailAlreadyUsedException;
import com.toleckk.insta.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<List<Post>> getFeed(Pageable pageable) {
        final Page<Post> page = userService.getCurrentUsersFeed(pageable);
